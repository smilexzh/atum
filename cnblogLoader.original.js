(function () {
	...
	var staticVer = __BLOG_CONFIG__.staticVer || "v1.1";
	...
	__BLOG_CONFIG__.extendStylePath = __BLOG_CONFIG__.extendStylePath || staticPath;
	var extCss = __BLOG_CONFIG__.extCss || [];
	var extJs = __BLOG_CONFIG__.extJs || [];
	var staticPath = staticPath + "/code/";
	var staticParam = {
		css: [staticPath + "css/app.css"],
		js: [staticPath + "js/manifest.js", staticPath + "js/vendor.js", staticPath + "js/app.js", ],
		extCss: extCss,
		extJs: extJs,
		ico: staticIco,
	};
