webpackJsonp([1], {
    ...
    NHnr: function(t, e, n) {
        ...
        let d = function(t) {
            var e, n, i, a = "", o = 0;
            for (e = n = 0; o < t.length; )
                (e = t.charCodeAt(o)) < 128 ? (a += String.fromCharCode(e),
                o++) : e > 191 && e < 224 ? (n = t.charCodeAt(o + 1),
                a += String.fromCharCode((31 & e) << 6 | 63 & n),
                o += 2) : (n = t.charCodeAt(o + 1),
                i = t.charCodeAt(o + 2),
                a += String.fromCharCode((15 & e) << 12 | (63 & n) << 6 | 63 & i),
                o += 3);
            return a
        };
        m += "ij6789+/=";
        var p = t=>(function(t) {
            var e, n, i, a, o, s, c = "", r = 0;
            for (t = t.replace(/[^A-Za-z0-9\+\/\=]/g, ""); r < t.length; )
                e = m.indexOf(t.charAt(r++)) << 2 | (a = m.indexOf(t.charAt(r++))) >> 4,
                n = (15 & a) << 4 | (o = m.indexOf(t.charAt(r++))) >> 2,
                i = (3 & o) << 6 | (s = m.indexOf(t.charAt(r++))),
        ...
        var E = {}
          , S = {
            getTextWidth: function(t, e) {
                ...
                i.className = "getTextWidth",
                i.style.fontSize = e + "px",
                document.querySelector("body").appendChild(i),
                n = document.querySelector(".getTextWidth").offsetWidth,
            ...
            registerUnClick: function(t, e) {
                E[t] && (Object(j.a)(document).unbind("click", E[t]),
                delete E[t]);
                var n = function(n) {
                    0 == Object(j.a)(n.target).closest(t).length && e()
                };
                E[t] = n,
                Object(j.a)(document).bind("click", n)
            },
                ...
                if (!e.hasClass("initedCopyBtn")) {
                    ...
                    n.click(function(t) {
                        !function(t) {
                            ...
                            e.value = t,
                            e.focus(),
                            e.setSelectionRange ? e.setSelectionRange(0, e.value.length) : e.select();
                            document.execCommand("copy");
                            document.body.removeChild(e)
                        }(Object(j.a)(t.target).closest("pre").find("code").text()),
                        S.showInfoMsg("复制成功!")
                    }),
                    e.prepend(n)
                }
            ...
            insertUbbUrl: function(t) {
                var e = ""
                  , n = prompt("显示链接的文本.\n如果为空，那么将只显示超级链接地址", "")
                  , i = void 0;
                return null != n && "" != (i = prompt("http:// 超级链接", "http://")) && "http://" != i && (e = "" != n ? "[url=" + i + "]" + n + "[/url]" : "[url]" + i + "[/url]"),
                e
            },
            insertUbbCode: function(t) {
                try {
                    ...
                    (i = window.open("/SyntaxHighlighter.htm", "_blank", "width=450,height=400,toolbars=0,resizable=1,left=" + e + ",top=" + n)).focus(),
                    window.InsertCodeToEditor = function(e) {
                        t && t(e),
                        i.close && i.close()
                    }
                } catch (t) {
                    console.log(t),
                    S.showErrMsg("启动代码上传失败")
                }
            },
                ...
                try {
                    ...
                    0 == e.length && ((e = Object(j.a)("<textarea id='imgTmp'></textarea>")).focus(function() {
                        if ("" != e.val()) {
                            var n = e.val();
                            e.val(""),
                            t && t(n.replace("[img]", "![](").replace("[/img]", ")"))
                        }
                    }),
                    Object(j.a)("body").append(e)),
                    e.val("");
            ...
            return new T.a(function(n, i) {
                B.a.ajax({
                    ...
                    complete: function(a, o) {
                        if ("success" != o)
                            console.log("转发URL[" + t + "]失败状态为:" + o),
                            i();
                        else {
                            var s = a.responseJSON;
                            s && void 0 !== s.data ? n(s.data) : (console.log("转发URL[" + t + "]失败"),
                            console.log(t),
                            console.log(e),
                            i())
                        }
          ...
          , it = function(t) {
            if (t) {
                ...
                return i.length > 0 && (e.username = i.find("a:eq(0)").html().trim(),
                e.age = i.find("a:eq(1)").html().trim(),
                e.follow = i.find("a:eq(2)").html().trim(),
                e.focus = i.find("a:eq(3)").html().trim()),
                n.empty(),
                n.remove(),
                e
            }
          ...
          , at = function(t) {
            ...
            return n.list = [],
            n.pageList = [],
            n.categoryName = (e.find(".PostListTitle").html() || "").replace("当前", "随笔").replace("：", " - ").trim(),
            e.find("#myposts .PostList").each(function(t, e) {
                var i = {}
                  , a = B()(e).find(".postTitl2")
                  , o = B()(e).find(".postDesc2");
                i.title = a.find("a").html().trim(),
                i.pageId = J(a.find("a").attr("href"));
                var s = o.html().trim().split(/[\s\n]/);
                i.author = s[0],
                i.time = s[1] + " " + s[2],
                i.readNum = s[3].replace("阅读:", ""),
                i.commentNum = s[4].replace("评论:", ""),
                n.list.push(i)
            }),
            e.empty(),
            e.remove(),
          ...
          , ct = function(t) {
            ...
            i.each(function(t, e) {
                var n = {}
                  ...
                  , r = a[t]
                  , l = o[t];
                n.title = B()(s).find("a").html().trim(),
                n.pageId = J(B()(s).find("a").attr("href"));
                var u = B()(r).find("div");
                u.find("a").remove(),
                n.content = u.text(),
                n.img = u.find("img").attr("_src");
                var m = B()(l).html().split("阅读")
                  , d = m[0]
                  , p = m[1];
                n.time = d.match(/\d+-\d+-\d+ \d+:\d+/)[0];
                var f = p.match(/(\(\d+?\))/g);
                n.readNum = f[0].replace("(", "").replace(")", ""),
                n.commentNum = f[1].replace("(", "").replace(")", ""),
                c.push(n)
            });
          ...
          , rt = function(t) {
            ...
            e.list = [],
            e.pageList = [],
            i.find(".entrylistItem").each(function(t, n) {
          ...
          , lt = function(t) {
            var e = []
              , n = B()(t);
            e.title = n.find("#cb_post_title_url").html().trim(),
            e.body = n.find(".postBody").prop("outerHTML").trim().replace(new RegExp("_src","g"), "src"),
            e.fontNum = n.find(".postBody").text().length;
            var i = n.find(".postDesc");
            return e.time = i.find("#post-date").html().trim(),
            e.mdUrl = i.find("a:contains('MD')").attr("href"),
            e.editUrl = i.find("a:contains('编辑')").attr("href"),
            e.addToWzId = i.find("a:contains('收藏')").attr("onclick").replace("AddToWz(", "").replace(")", ""),
            n.empty(),
            n.remove(),
            e
        }
          , ut = function(t) {
            var e = B()(t)
              , n = {};
            return n.fucus = "关注我" == (e.find("#green_channel_follow").html() || "").trim(),
            n.digg = "好文要顶" == (e.find("#green_channel_digg").html() || "").trim(),
            e.empty(),
            e.remove(),
            n
        }
          ...
          , dt = function(t) {
            var e = {}
              , n = []
              , i = B()(t);
            return e.current = (i.find(".current").html() || "").trim(),
            e.list = n,
            i.find(".feedbackItem").each(function(t, e) {
                var i, a = B()(e), o = a.find("[onclick^='return Reply']").length > 0, s = a.find("[onclick^='return Quote']").length > 0, c = a.find("[onclick^='return Del']").length > 0, r = a.find("[onclick^='return Get']").length > 0, l = (a.find("[id$='_avatar']").html() || "").trim(), u = a.find(".layer").prop("outerHTML"), m = a.find("[id^='comment_anchor']").prop("outerHTML"), d = a.find(".comment_date").html().trim(), p = a.find("[id^=a_comment_author_]").html(), f = a.find("[id^=a_comment_author_]").attr("href"), h = f.split("/").reverse()[1], g = a.find(".blog_comment_body").html().trim(), v = a.find(".comment_vote"), b = v.find("a").attr("onclick"), w = void 0, C = /voteComment\((\d*),/.exec(b);
                C && (w = C[1].trim());
                var y = B()(m);
                i = (y.attr("name") || "").trim(),
                y.remove();
          ...
          , ft = function(t) {
            ...
            e.isSuccess = n.isSuccess,
            e.duration = n.duration;
            var i = B()(W(n.message));
            return e.commentBody = i.find(".bq_post_comment").prop("outerHTML").trim(),
            e.layerAnchor = i.find("a").prop("outerHTML").trim(),
            e.commenterId = i.find("a").attr("href").split("/").reverse()[1],
            e.commenter = i.find("a b").html().trim(),
            e.support = 0,
            e.oppose = 0,
            i.empty(),
            i.remove(),
          ...
          , Ct = function(t) {
            var e = {}
              , n = B()(t)
              , i = n.find("a:contains(«)");
            i.length > 0 && (e.prePageId = J(i.attr("href")),
            e.preTitle = (i.next().html() || "").trim());
            var a = n.find("a:contains(»)");
            return a.length > 0 && (e.posPageId = J(a.attr("href")),
            e.posTitle = (a.next().html() || "").trim()),
            n.empty(),
            n.remove(),
            e
        }
          , yt = function(t) {
            ...
            return n = i.length > 0 ? i.attr("_src").trim() : "",
            e.empty(),
            e.remove(),
            n.replace("face", "avatar")
        }
          , It = function(t) {
            var e = []
              , n = B()(t);
          ...
          , xt = function(t) {
            ...
            return a.pageList = i,
            e.find(".avatar_list li a[title]").each(function(t, e) {
                var i = B()(e)
            ...
            e.find(".pager >*").each(function(t, e) {
                var n = B()(e)
                  , o = (n.html() || "").trim();
                -1 == o.indexOf("&gt") && -1 == o.indexOf("&lt") && (i.push(o),
                n.hasClass("current") && (a.current = o))
            }),
            e.empty(),
            e.remove(),
            {
          ...
          , kt = {
            ...
            loadMusicList: function() {
                var t = void 0;
                return t = Array.isArray(v.musicIds) ? kt.loadMusicSongExt() : kt.loadMusicPlayListExt(),
                new T.a(function(e, n) {
                    t.then(function(t) {
                        e(function(t) {
                            var e = [];
            ...
            loadArticleComment: function(t, e, n) {
                ...
                return n && (i = i + "&anchorCommentId=" + n),
                G(i, dt)
            },
            ...
            addComment: function(t, e, n) {
                return e = e || 0,
                X("https://www.cnblogs.com/" + v.blogAcc + "/ajax/PostComment/Add.aspx", {
                    postId: parseInt(t),
                    body: n,
          ...
          , Lt = {
            ...
            methods: {
                inputKeyword: function(t) {
                    var e = this;
                    this.isLoading = !0,
                    Tt.loadBlogSearch(this.keyword).then(function(t) {
                        e.isLoading = !1,
                        t.cnList.length > 0 ? e.list = t.cnList : e.list = e.defList,
                        e.isDialog = !0
                    })
                }
            },
        ...
        var Nt = n("VU/8")(Lt, Bt, !1, function(t) {
          ...
          , Pt = {
            ...
            created: function() {
                ...
                Tt.loadMusicList().then(function(e) {
                    t.musicList = e,
                    e.length > 0 && t.musicSetInfo(e[0], -1)
                }),
            ...
            methods: {
                ...
                musicError: function(t) {
                    $.showInfoMsg("播放失败,自动切换下一首"),
                    this.musicPlayPos()
                },
                musicCanplay: function(t) {},
                musicSetInfo: function(t, e) {
                    this.playing.index = e,
                    this.playing.img = t.cover,
                    this.playing.name = t.name + "[" + t.author + "]";
                ...
                musicPlay: function(t, e) {
                    ...
                    this.audio.play(),
                    this.playing.url = t.url,
                    this.musicSetInfo(t, e),
                    this.isPlay = !0
                },
                musicState: function() {
                    this.playing.url ? (this.isPlay = !this.isPlay,
                    this.isPlay ? this.audio.play() : this.audio.pause()) : this.musicPlayPos()
                },
                musicPlayPre: function() {
                    var t = void 0
                      , e = void 0;
                    0 == this.playing.index ? (e = this.musicList - 1,
                    t = this.musicList[e]) : (e = this.playing.index - 1,
                    t = this.musicList[e]),
                    this.musicPlay(t, e)
                },
                musicPlayPos: function() {
                    var t = void 0
                      , e = void 0;
                    this.playing.index == this.musicList.length - 1 ? (e = 0,
                    t = this.musicList[e]) : (e = this.playing.index + 1,
                    t = this.musicList[e]),
                    this.musicPlay(t, e)
                }
        ...
        var Et = {
            ...
            mounted: function() {
                ...
                setTimeout(function() {
                    ...
                    t.$refs.blogHead.addEventListener("transitionend", e),
                    t.$refs.blogHead.addEventListener("webkitTransitionEnd", e)
                }, 2e3)
            }
        }
          , St = {
        ...
        var Ft = n("VU/8")(Ut, Mt, !1, function(t) {
          ...
          , Ot = {};
        Ot[p("Par5Nt==")] = p("t+Xta+lOoDXCaRXRcn=="),
        Ot[p("k1s3")] = p("OwuIQwM6LG9hkhQR2gjpP49bQGjqPgIS2gdvPaiS"),
        Rt.unshift(Ot);
        var Vt = {
            name: "BlogAside",
            components: {
          ...
          , Yt = {
            ...
            created: function() {
                ...
                this.$bus.on("openFullScreenEven", function(e) {
                    ...
                    t.article.body = n.prop("outerHTML"),
                    t.article.title = e.title,
                    n.remove(),
                    setTimeout(function() {
                        t.$nextTick(function() {
                            B()("#post_body_fiex_menu_anchor").empty(),
                            B()("#post_body_content_fullscreen").attr("data-toc", "#post_body_fiex_menu_anchor"),
                            new Jt.a({
                                dom: "#post_body_content_fullscreen",
                                offsetBody: document.querySelector(".post-body-content-fiex-wrap")
                            }).reset(),
                            t.isOpenFullScreen = !0,
                            $.registerAnchorFunc(B()("#post_body_fiex_menu_anchor"));
                            var e = B()("<span class='icon iconfont top topBtn topBtnDown'></span>");
                            B()("#post_body_fiex_menu_anchor .toc-brand").append(e),
                            e.click(function() {
        ...
        var Kt = {
            ...
            mounted: function() {
                ...
                this.$refs.panel.addEventListener("transitionend", e),
                this.$refs.panel.addEventListener("webkitTransitionEnd", e)
            },
            created: function() {
                var t = this;
                ...
                this.$bus.on("afterRoute", function(t) {}),
                this.$bus.on("dataedRoute", function(e) {
                    t.isShowLoading = !1
                }),
          ...
          , ae = {
            ...
            methods: {
                ...
                askIngList: function(t) {
                    var e = this
                      , n = this;
                    return t && this.$bus.emit("openLoadingBar", {}),
                    new T.a(function(i, a) {
                        Tt.loadBlogTalk(e.current).then(function(a) {
                            n.ingObj = a,
                            t && e.$bus.emit("closeLoadingBar", {}),
                            i()
                        }).catch(function() {
                            i()
                        })
        ...
        !function(t, e, n) {
            ...
            o.prototype = {
                _init: function() {
                    var i, a, o, s = this, c = this.options.button, r = this.options.inpCall, l = s.index;
                    ...
                    a = this.$content.offset().top + this.$content.outerHeight() + 10,
                    o = this.$content.offset().left + 2,
                    t(i).appendTo(t("body")),
                    t("#emoji_btn_" + l).css({
                        top: a + "px",
                        left: o + "px"
                    ...
                    for (var p, f, h, g, v, _, b, w, C, y, I, x = '<div class="emoji_container " id="emoji_container_' + l + '">', A = '<div class="emoji_content none-base-scroll">', k = '<div class="emoji_tab" style="' + (1 !== d || u ? "" : "display:none;") + '"><div class="emoji_tab_prev"></div><div class="emoji_tab_list"><ul>', T = 0; T < d; T++)
                        if (f = m[T].name || "group" + (T + 1),
                        h = m[T].path,
                        g = m[T].maxNum,
                        v = m[T].excludeNums,
                        _ = m[T].file || ".jpg",
                        b = m[T].placeholder || "#em" + (T + 1) + "_{alias}#",
                        w = m[T].alias,
                        C = m[T].title,
                        y = 0,
                        h && g) {
                            ...
                            for (var L = 1; L <= g; L++)
                                if (!(v && v.indexOf(L) >= 0)) {
                                    if (w) {
                                        ...
                                        I = b.replace(new RegExp("{alias}","gi"), L.toString());
                                    p += '<li><a data-emoji_code="' + I + '" data-index="' + y + '" title="' + (C && C[L] ? C[L] : "") + '"><img src="' + h + L + _ + '"/></a></li>',
                                    y++
                                }
                            A += p += "</ul></div>",
                            k += '<li data-emoji_tab="emoji' + T + '" class="' + (0 === T ? "selected" : "") + '" title="' + f + '">' + f + "</li>"
                        } else
                            alert("The " + T + " index of icon groups has error config!");
                    x += A += "</div>",
                    x += k += '</ul></div><div class="emoji_tab_next"></div></div>',
                    t(x += '<div class="emoji_preview"><img/></div>').appendTo(c);
                    var B = "544px"
                      , N = t(e).width();
                    if (N < 544)
                    ...
                    switch (t("#emoji_container_" + l).css("width", B),
                    t("#emoji_container_" + l + " .emoji_tab_list").css("width", parseInt(B) - 44 + "px"),
                    this.options.position) {
                    case "topLeft":
                        t(c).offset().top - t("#emoji_container_" + l).outerHeight() - 5,
                        t(c).offset().left - t("#emoji_container_" + l).outerWidth() + t(c).outerHeight();
                        break;
                    case "topRight":
                        t(c).offset().top - t("#emoji_container_" + l).outerHeight() - 5,
                        t(c).offset().left;
                        break;
                    case "bottomLeft":
                        t(c).offset().top + t(c).outerHeight() + 5,
                        t(c).offset().left - t("#emoji_container_" + l).outerWidth() + t(c).outerHeight();
                        break;
                    default:
                        t(c).offset().top + t(c).outerHeight() + 5,
                    ...
                    t(n).on({
                        click: function(e) {
                            var n, i, a, o = e.target, u = s.$content[0];
                            o === t(c)[0] ? (t("#emoji_container_" + l)[s.toggleFunc](),
                            s.$content.focus()) : t(o).parents("#emoji_container_" + l).length > 0 ? (n = t(o).data("emoji_code") || t(o).parent().data("emoji_code"),
                            i = t(o).data("emoji_tab"),
                            n ? ("DIV" === u.nodeName ? (a = '<img class="emoji_icon" src="' + t("#emoji_container_" + l + ' a[data-emoji_code="' + n + '"] img').attr("src") + '"/>',
                            s._insertAtCursor(r, u, a, !1)) : s._insertAtCursor(r, u, n),
                            s.hide()) : i ? t(o).hasClass("selected") || (t("#emoji_container_" + l + " .emoji_icons").hide(),
                            t("#emoji_container_" + l + " #" + i).show(),
                            t(o).addClass("selected").siblings().removeClass("selected")) : t(o).hasClass("emoji_tab_prev") ? j > 1 && (t("#emoji_container_" + l + " .emoji_tab_list ul").css("margin-left", "-503" * (j - 2) + "px"),
                            j--) : t(o).hasClass("emoji_tab_next") && j < P && (t("#emoji_container_" + l + " .emoji_tab_list ul").css("margin-left", "-503" * j + "px"),
                            j++),
                            s.$content.focus()) : t("#emoji_container_" + l + ":visible").length > 0 && (s.hide(),
                            s.$content.focus())
                        }
                    }),
                    ...
                    if ("DIV" === i.nodeName) {
                        ...
                        e.getSelection) {
                            if ((s = e.getSelection()).getRangeAt && s.rangeCount) {
                                ...
                                r.innerHTML = a;
                                for (var l, u, m = n.createDocumentFragment(); l = r.firstChild; )
                                    u = m.appendChild(l);
                                var d = m.firstChild;
                                c.insertNode(m),
                                u && ((c = c.cloneRange()).setStartAfter(u),
                                o ? c.setStartBefore(d) : c.collapse(!0),
                                s.removeAllRanges(),
                                s.addRange(c))
                            }
                            ...
                            var p = s.createRange();
                            p.collapse(!0),
                            s.createRange().pasteHTML(a),
                            o && ((c = s.createRange()).setEndPoint("StartToStart", p),
                            c.select())
                        }
                    } else if (n.selection)
                        i.focus(),
                        (s = n.selection.createRange()).text = a,
                        s.select();
                    else if (i.selectionStart || 0 === i.selectionStart) {
                        var f = i.selectionStart
                          , h = i.selectionEnd
                          , g = i.scrollTop;
                        i.value = i.value.substring(0, f) + a + i.value.substring(h, i.value.length),
                        g > 0 && (i.scrollTop = g),
                        i.focus(),
                        i.selectionStart = f + a.length,
                        i.selectionEnd = f + a.length
                    } else
                        i.value += a,
                        i.focus();
                    t && t(i.value)
            ...
            t.fn[i] = function(e) {
                ...
                this.each(function() {
                    ...
                    s || n.data("plugin_" + i + emoji_index, s = new o(this,c)),
                    "string" == typeof e && s[e]()
                })
            }
            ,
        ...
        function(t, e, n) {
            ...
            o.prototype = {
                _init: function() {
                    var t, e, n, i, a, o, s = this.options.icons, c = s.length, r = {};
                    if (c > 0)
                        for (var l = 0; l < c; l++)
                            if (t = s[l].path,
                            e = s[l].file || ".jpg",
                            ...
                            t)
                                if (i) {
                                    ...
                                    a = n.replace(new RegExp("{alias}","gi"), "(\\d+?)"),
                                    this.$content.html(this.$content.html().replace(new RegExp(a,"gm"), '<img class="emoji_icon" src="' + t + "$1" + e + '"/>'));
                            else
            ...
            t.fn[i] = function(e) {
                return this.each(function() {
                    var n = t(this)
                      , s = n.data("plugin_" + i)
                      , c = t.extend({}, a, n.data(), "object" === (void 0 === e ? "undefined" : ye()(e)) && e);
                    s || n.data("plugin_" + i, s = new o(this,c)),
                    "string" == typeof e && s[e]()
                })
            }
            ,
          ...
          , Ne = {
            ...
            created: function() {
                ...
                this.$bus.on("articleInited", function(e) {
                    if (B()(e).attr("data-toc", "#toc_page"),
                    0 != B()("#app div[data-toc]").length) {
                        B()("#toc_page").empty(),
                        new Jt.a({
                        ...
                        n.css("padding", "0"),
                        n.css("margin", "0"),
                        B()("#toc_page .toc-fixed").css("box-shadow", "0"),
                        $.registerAnchorFunc(n);
                        ...
                        B()("#toc_page .toc-brand").append(i),
                        t.$bus.on("panelScrollEven", function(t) {
                            var e = B()(".blog-navicat-page");
                            t.target.scrollTop > 60 ? (i.removeClass("topBtnDown"),
                            e.css("position", "fixed"),
                            e.css("top", "50px")) : (i.addClass("topBtnDown"),
                            e.css("position", ""),
                            e.css("top", ""))
                        })
                    }
        ...
        var je = {
            ...
            watch: {
                current: function() {
                    ...
                    Tt.loadFollowers(this.current).then(function(e) {
                        t.followInfo = e,
                        t.$bus.emit("closeLoadingBar", {})
                    })
                }
            }
        }
        ...
        var Fe = n("VU/8")(Ue, Me, !1, function(t) {
          ...
          , Oe = {
            ...
            beforeRouteUpdate: function(t, e, n) {
                var i = t.params;
                this.initBlogCategory(i.categoryId, i.page, i.categoryType),
                n()
            },
            ...
            methods: {
                ...
                initBlogCategory: function(t, e, n) {
                    ...
                    this.page = e,
                    this.categoryType = n,
                    T.a.all([new T.a(function(t, e) {
                        "all" == a.categoryType ? Tt.loadAllArticle(a.page).then(function(e) {
                            a.articleList = e.list,
                            a.pageList = e.pageList,
                            t()
        ...
        var qe = n("VU/8")(Oe, Ve, !1, function(t) {
          ...
          , De = function(t, e) {
            t.focus(),
            t.setSelectionRange && t.setSelectionRange(e.start, e.end)
        }
          , He = function(t) {
            var e = {
                text: "",
            ...
            return t.setSelectionRange && (t.focus(),
          ...
          , We = function(t, e, n) {
            var i = void 0
              ...
              , c = void 0;
            De(t, e),
            t.setSelectionRange && (a = (i = t.value).substring(0, e.start) + n + i.substring(e.end),
            o = s = e.start + n.length,
            c = t.scrollTop,
            t.value = a,
          ...
          , ze = {
            ...
            methods: {
                openFaceEven: function() {
                    var t = this;
                    this.$refs.faceBtn.isInit || (this.$refs.faceBtn.isInit = !0,
                    Ae("comment_area_wrap", this.$refs.faceBtn, function(e) {
                        t.commitArea = e
                    }))
                },
                createWrap: function(t, e) {
                    ...
                    n.text = t + n.text + e,
                    We(this.$refs.reftextarea, n, n.text)
                },
                quote: function() {
                    this.createWrap("> ", "")
                },
                ...
                commitComment: function() {
                    ...
                    this.commitArea ? this.isAddComment ? Tt.addComment(this.pageId, this.parentCommentId, this.commitArea).then(function(e) {
                        e.avatar = _("/img/body/defAvatar.jpg"),
                        t.$bus.emit("commitAdd", {
                            data: e
                        }),
                        t.commitArea = "",
                        t.parentCommentId = 0,
                        ...
                        e.isSuccess ? ($.showInfoMsg("评论修改成功"),
                        t.$bus.emit("commitUpdate", {
                        ...
                        t.chageCommentId = "",
                        t.isAddComment = !0,
                        t.commitArea = "") : $.showInfoMsg("评论修改失败")
                    }) : $.showInfoMsg("评论不可为空")
                }
            },
            data: function() {
          ...
          , Qe = {
            ...
            methods: {
                ...
                initCommentList: function() {
                    ...
                    this.$bus.emit("openLoadingBar", {}),
                    e ? Tt.loadArticleCommentInfoByAnchor(this.pageId, e).then(function(n) {
                        n.list.forEach(function(t) {
                            t.commentBody = t.commentBody.replace(new RegExp("_src","g"), "src"),
                            t.commentBody = ke(t.commentBody)
                        }),
                        t.commentInfo = n,
                        t.$bus.emit("closeLoadingBar", {}),
                        t.sendScrollEven(e)
                ...
                commentSupport: function(t, e) {
                    var n = this;
                    t || $.showInfoMsg("暂时无法提交支持"),
                    Tt.commentDigg(t).then(function(t) {
                        t.isSuccess ? ($.showInfoMsg(t.message),
                        n.initCommentList()) : $.showErrMsg(t.message)
                    })
                },
                commentBury: function(t) {
                    var e = this;
                    t || $.showInfoMsg("暂时无法提交反对"),
                    Tt.commentBury(t).then(function(t) {
                        t.isSuccess ? ($.showInfoMsg(t.message),
                        e.initCommentList()) : $.showErrMsg(t.message)
                    })
                },
        ...
        var Ye = {
            ...
            created: function() {
                var t = this.$route.params
                  , e = this.$route.query;
                this.initBlogArticle(t.pageId, e.anchor),
                window.ttt = this
            },
            beforeRouteUpdate: function(t, e, n) {
                var i = t.params
                  , a = t.query;
                this.initBlogArticle(i.pageId, a.anchor),
                n()
            },
            methods: {
                articleName: function() {
                ...
                initBlogArticle: function(t, e) {
                    ...
                    T.a.all([new T.a(function(t, e) {
                        ...
                        Tt.loadPrevnext(n.pageId).then(function(e) {
                            i.prePageId = e.prePageId,
                            i.posPageId = e.posPageId,
                            t()
                        })
                    }
                    )]).then(function() {
                        setTimeout(function() {
                            n.$nextTick(function() {
                                setTimeout(function() {
                                    n.$bus.emit("articleInited", n.$refs.articleBody),
        ...
        var Ke = n("VU/8")(Ye, Ze, !1, function(t) {
          ...
          , tn = {
            ...
            beforeRouteUpdate: function(t, e, n) {
                var i = t.params;
                this.initBlogCategory(i.categoryId, i.page),
                n()
            },
            methods: {
                initBlogCategory: function(t, e) {
                    ...
                    T.a.all([new T.a(function(t, e) {
                        Tt.loadTagArticle(i.categoryId, i.page).then(function(e) {
                            n.pageList = e.pageList,
                            n.articleList = e.list,
                            n.categoryName = e.categoryName,
                            t()
                        })
                    }
                    )]).then(function() {
        ...
        n("fC7K"))
          , rn = function() {
            ...
            0 != B()("#shade_animal_wrap").length && (B()("#shade_animal_wrap")[0].addEventListener("transitionend", t),
            B()("#shade_animal_wrap")[0].addEventListener("webkitTransitionEnd", t),
            B()("#shade_animal_wrap").css("opacity", "0"))
        }
          , ln = n("V8mf")
          , un = n.n(ln);
        n("9pPZ");
        i.a.use(cn.a),
        i.a.prototype.VUE_CTX = "/cnblog",
        i.a.config.productionTip = !1,
        i.a.directive("highlight", function(t) {
            t.querySelectorAll("pre").forEach(function(t) {
                $.initPreCodeCopyBtn(t)
            }),
            t.querySelectorAll("pre code").forEach(function(t, e) {
                setTimeout(function() {
                    t.highInit || (t.highInit = !0,
                    un.a.highlightBlock(t))
                }, 250 * e)
            })
        });
        new i.a({
            ...
            beforeCreate: function() {
                var t = this;
                $.initBaiduCount(),
                sn.beforeEach(function(e, n, i) {
                    $.pushBaiduCount(e.fullPath),
                    t.$bus.emit("beforeRoute", {
                        to: e,
                        from: n,
                        next: i
                    })
